...
const ACTION_LABELS: Record<string, string> = {
  ...
  archives_view:  'Voir les archives vidéo',
  archives_edit:  'Gérer les archives vidéo',
...
const ACTION_DESC: Record<string, string> = {
  ...
  archives_view:   'Page Archives vidéo dans l\'espace membre (vidéastes + responsable louange)',
  archives_edit:   'Saisie et modification des métadonnées vidéo (fiche vidéo)',
